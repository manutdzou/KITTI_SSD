...
if __name__ == "__main__":
  ...
  parser.add_argument("--root",
      help="The root directory which contains the images and annotations.",
                      default="/home/bsl/Debug/ssd_caffe/data/KITTI")
  parser.add_argument("--listfile",
      help="The file which contains image paths and annotation info.",
                      default="/home/bsl/Debug/ssd_caffe/data/KITTI/train.txt")
  parser.add_argument("--outdir",
      help="The output directory which stores the database file.",
                      default="/home/bsl/Debug/ssd_caffe/data/KITTI/lmdb/KITTI_train_lmdb")
  parser.add_argument("--exampledir",
      help="The directory to store the link of the database files.",
                      default="/home/bsl/Debug/ssd_caffe/examples/KITTI")
  parser.add_argument("--redo", default = 1, action = "store_true",
  ...
  parser.add_argument("--encode-type", default = "png",
  ...
  parser.add_argument("--label-map-file", default = "/home/bsl/Debug/ssd_caffe/data/KITTI/labelmap_KITTI.prototxt",
